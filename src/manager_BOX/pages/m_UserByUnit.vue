...
import { manager_users_per_department, manager_users_per_department_no_pages } from "../../services/api";
...
onMounted(async () => {
  ...
  manager_users_per_department(deptName, { region }),
  manager_users_per_department_no_pages(deptName, { region })
]);
